...
public class DefaultJeepSalesDao implements JeepSalesDao {
	Logger logz = LoggerFactory.getLogger(DefaultJeepSalesDao.class);
	...
	public List<Jeeps> fetchJeeps(JeepModel model, String trim) {
		...
		return jdbcTemplate.query(sql, params, 
				new RowMapper<>() {
			@Override
			public Jeeps mapRow(ResultSet rs, int rowNum) throws SQLException {
			
			// @formatter:off
				return Jeeps.builder()
